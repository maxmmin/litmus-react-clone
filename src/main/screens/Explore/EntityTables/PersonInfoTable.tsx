...
const PersonInfoTable = ({person}: Props) => {
    ...
    <div className={"entity-container person-container"}>
        ...
        <div className="entity-container__value entity-container__value-block_person"><p className="entity-container__value entity-container__value_person">{person.dateOfBirth?person.dateOfBirth.join("/"):noInfoMessage}</p></div>
