...
export default class UserExplorationState implements EntityExplorationState<User, UserExplorationParams> {
    readonly data: EntityExplorationData<User, UserExplorationParams>;
    readonly params: UserExplorationParams;

    constructor(data: EntityExplorationData<User, UserExplorationParams>, params: UserExplorationParams) {
        this.data = data;
        this.params = params;
    }
}
